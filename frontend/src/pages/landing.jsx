...
import ImageStreamHero, { DEFAULT_STREAM_IMAGES } from "../components/ui/ImageStreamHero";
...
export const Landing = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--canvas)" }}>
      ...
      {/* ─── 1. Cinematic 3D ImageStream Hero Section ─── */}
      <section style={{ padding: "24px 24px 32px 24px", maxWidth: "1200px", margin: "0 auto", width: "100%" }}>
        <ImageStreamHero
          ...
          style={{
            ...
            boxShadow: "0 28px 70px rgba(0,0,0,0.8), 0 0 30px rgba(88, 101, 242, 0.18)",
          }}
        >
          {/* Subtle vignette layer for high text contrast */}
          <div
            style={{
              position: "absolute",
              inset: 0,
              background:
                "radial-gradient(circle at 50% 50%, rgba(9, 10, 16, 0.85) 0%, rgba(9, 10, 16, 0.5) 55%, rgba(9, 10, 16, 0.94) 90%)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            ...
            {/* Centerpiece Headline & Subtitle & Actions */}
            <div style={{ maxWidth: "800px", margin: "16px auto" }}>
              ...
              >
                High-quality WebRTC video meetings without complicated setup or app downloads.
              </p>
              ...
              >
                ...
                <form onSubmit={handleQuickJoin} style={{ display: "flex", gap: "8px", flex: "1 1 220px" }}>
                  <div style={{ flex: 1 }}>
                    <Input
                      icon={KeyboardIcon}
